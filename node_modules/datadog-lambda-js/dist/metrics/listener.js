...
var MetricsListener = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, (0, extension_1.isExtensionRunning)()];
                    case 1:
                        _a.isExtensionRunning = _b.sent();
                        (0, utils_1.logDebug)("Extension present: ".concat(this.isExtensionRunning));
                        _b.label = 2;
                    case 2:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 7:
                        ...
                        return [3 /*break*/, 8];
                    case 8:
                        if (!this.isExtensionRunning) return [3 /*break*/, 10];
                        return [4 /*yield*/, (0, extension_1.flushExtension)(this.config.localTesting)];
                    case 9:
                        _a.sent();
                        _a.label = 10;
                    case 10:
    ...
    MetricsListener.prototype.sendDistributionMetricWithDate = function (name, value, metricTime, // TODO: Next breaking change to update to optional or 'Date | undefined'?
    forceAsync) {
        var _a;
        var tags = [];
    ...
    MetricsListener.prototype.createProcessor = function (config, apiKey) {
        return __awaiter(this, void 0, void 0, function () {
            var APIClient, Processor, key, url, apiClient, processor;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!this.config.logForwarding) return [3 /*break*/, 2];
                        APIClient = require("./api").APIClient;
                        Processor = require("./processor").Processor;
                        return [4 /*yield*/, apiKey];
                    case 1:
                        key = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(config.apiKeyKMS !== "")) return [3 /*break*/, 4];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                    ...
                    case 3:
                        error_2 = _a.sent();
                        (0, utils_1.logError)("couldn't decrypt kms api key", error_2);
                        return [3 /*break*/, 4];
