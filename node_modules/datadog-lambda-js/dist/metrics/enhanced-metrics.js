...
exports.incrementBatchItemFailureMetric = exports.incrementErrorsMetric = exports.incrementInvocationsMetric = exports.getEnhancedMetricTags = exports.getRuntimeTag = exports.getVersionTag = void 0;
...
function getEnhancedMetricTags(context) {
    ...
    if (context) {
        ...
        tags.push.apply(tags, __spreadArray(__spreadArray([], __read(arnTags), false), ["memorysize:".concat(context.memoryLimitInMB)], false));
    }
    tags.push.apply(tags, __spreadArray(__spreadArray([], __read((0, cold_start_1.getSandboxInitTags)()), false), [getVersionTag()], false));
...
function incrementBatchItemFailureMetric(listener, count, context) {
    listener.sendDistributionMetric.apply(listener, __spreadArray(["aws.lambda.enhanced.batch_item_failures",
        count,
        true], __read(getEnhancedMetricTags(context)), false));
}
exports.incrementBatchItemFailureMetric = incrementBatchItemFailureMetric;
