...
function promisifiedHandler(handler) {
    ...
    if (handler[constants_1.HANDLER_STREAMING] !== undefined && handler[constants_1.HANDLER_STREAMING] === constants_1.STREAM_RESPONSE) {
        return function (event, responseStream, context) {
            // This handler will always be a promise.
            var promise = handler(event, responseStream, context);
            return promise;
        };
    }
