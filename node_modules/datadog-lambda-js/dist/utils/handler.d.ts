...
export declare function promisifiedHandler<TEvent, TResult>(handler: Handler<TEvent, TResult> | any): ((event: any, responseStream: any, context: Context) => Promise<unknown>) | ((event: TEvent, context: Context) => Promise<TResult | undefined>);
