...
var TracerWrapper = /** @class */ (function () {
    ...
    TracerWrapper.prototype.extract = function (event) {
        ...
        var extractedSpanContext = this.tracer.extract("text_map", event);
        if (!extractedSpanContext)
            return null;
        var spanContext = new span_context_wrapper_1.SpanContextWrapper(extractedSpanContext, trace_context_service_1.TraceSource.Event);
        return spanContext;
    };
    ...
    TracerWrapper.prototype.traceContext = function () {
        ...
        return new span_context_wrapper_1.SpanContextWrapper(span.context(), trace_context_service_1.TraceSource.DdTrace);
    };
