...
var ColdStartTracer = /** @class */ (function () {
    ...
    ColdStartTracer.prototype.trace = function (rootNodes) {
        ...
        var coldStartSpanEndTime = Math.min((_c = rootNodes[rootNodes.length - 1]) === null || _c === void 0 ? void 0 : _c.endTime, this.currentSpanStartTime);
        var targetParentSpan;
        if (this.isColdStart) {
            var coldStartSpan = this.createColdStartSpan(coldStartSpanStartTime, coldStartSpanEndTime, this.parentSpan);
    ...
    ColdStartTracer.prototype.createColdStartSpan = function (startTime, endTime, parentSpan) {
        var options = {
            tags: {
                service: "aws.lambda",
